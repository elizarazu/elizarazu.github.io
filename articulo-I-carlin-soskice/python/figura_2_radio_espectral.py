...
cbar.set_label(r"Radio espectral $ho(A)$")
...
fig.savefig(output / "figura_2_radio_espectral.pdf", bbox_inches="tight")
fig.savefig(output / "figura_2_radio_espectral.svg", bbox_inches="tight")
plt.close(fig)
